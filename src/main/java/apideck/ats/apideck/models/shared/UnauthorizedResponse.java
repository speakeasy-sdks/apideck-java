...
public class UnauthorizedResponse {
     ...
     * Contains parameter or domain specific information related to the error and why it occurred.
     */
    public UnauthorizedResponse withDetail(Optional<? extends String> detail) {
        Utils.checkNotNull(detail, "detail");
        this.detail = detail;
        return this;
    }
     ...
     * Contains an explanation of the status_code as defined in HTTP/1.1 standard (RFC 7231)
     */
    public UnauthorizedResponse withError(Optional<? extends String> error) {
        Utils.checkNotNull(error, "error");
        this.error = error;
        return this;
    }
     ...
     * A human-readable message providing more details about the error.
     */
    public UnauthorizedResponse withMessage(Optional<? extends String> message) {
        Utils.checkNotNull(message, "message");
        this.message = message;
        return this;
    }
     ...
     * Link to documentation of error type
     */
    public UnauthorizedResponse withRef(Optional<? extends String> ref) {
        Utils.checkNotNull(ref, "ref");
        this.ref = ref;
        return this;
    }
     ...
     * HTTP status code
     */
    public UnauthorizedResponse withStatusCode(Optional<? extends Double> statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * The type of error returned
     */
    public UnauthorizedResponse withTypeName(Optional<? extends String> typeName) {
        Utils.checkNotNull(typeName, "typeName");
        this.typeName = typeName;
        return this;
    }
