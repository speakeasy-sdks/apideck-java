...
public class JobsOneResponse implements apideck.ats.apideck.utils.Response {
     ...
     * Jobs
     */
    private Optional<? extends apideck.ats.apideck.models.shared.GetJobResponse> getJobResponse;
    ...
    public JobsOneResponse(
            Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse,
            String contentType,
            Optional<? extends apideck.ats.apideck.models.shared.GetJobResponse> getJobResponse,
     ...
     * Jobs
     */
    public Optional<? extends apideck.ats.apideck.models.shared.GetJobResponse> getJobResponse() {
     ...
     * Bad Request
     */
    public JobsOneResponse withBadRequestResponse(Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse) {
        Utils.checkNotNull(badRequestResponse, "badRequestResponse");
        this.badRequestResponse = badRequestResponse;
        return this;
    }
     ...
     * Jobs
     */
    public JobsOneResponse withGetJobResponse(Optional<? extends apideck.ats.apideck.models.shared.GetJobResponse> getJobResponse) {
        Utils.checkNotNull(getJobResponse, "getJobResponse");
        this.getJobResponse = getJobResponse;
        return this;
    }
     ...
     * The specified resource was not found
     */
    public JobsOneResponse withNotFoundResponse(Optional<? extends apideck.ats.apideck.models.shared.NotFoundResponse> notFoundResponse) {
        Utils.checkNotNull(notFoundResponse, "notFoundResponse");
        this.notFoundResponse = notFoundResponse;
        return this;
    }
     ...
     * Payment Required
     */
    public JobsOneResponse withPaymentRequiredResponse(Optional<? extends apideck.ats.apideck.models.shared.PaymentRequiredResponse> paymentRequiredResponse) {
        Utils.checkNotNull(paymentRequiredResponse, "paymentRequiredResponse");
        this.paymentRequiredResponse = paymentRequiredResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public JobsOneResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public JobsOneResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Unauthorized
     */
    public JobsOneResponse withUnauthorizedResponse(Optional<? extends apideck.ats.apideck.models.shared.UnauthorizedResponse> unauthorizedResponse) {
        Utils.checkNotNull(unauthorizedResponse, "unauthorizedResponse");
        this.unauthorizedResponse = unauthorizedResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public JobsOneResponse withUnexpectedErrorResponse(Optional<? extends apideck.ats.apideck.models.shared.UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
     ...
     * Unprocessable
     */
    public JobsOneResponse withUnprocessableResponse(Optional<? extends apideck.ats.apideck.models.shared.UnprocessableResponse> unprocessableResponse) {
        Utils.checkNotNull(unprocessableResponse, "unprocessableResponse");
        this.unprocessableResponse = unprocessableResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        JobsOneResponse other = (JobsOneResponse) o;
        return 
            java.util.Objects.deepEquals(this.badRequestResponse, other.badRequestResponse) &&
            java.util.Objects.deepEquals(this.contentType, other.contentType) &&
            java.util.Objects.deepEquals(this.getJobResponse, other.getJobResponse) &&
    ...
    public String toString() {
        return Utils.toString(JobsOneResponse.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends apideck.ats.apideck.models.shared.GetJobResponse> getJobResponse = Optional.empty();
         ...
         * Jobs
         */
        public Builder getJobResponse(apideck.ats.apideck.models.shared.GetJobResponse getJobResponse) {
            Utils.checkNotNull(getJobResponse, "getJobResponse");
            this.getJobResponse = Optional.ofNullable(getJobResponse);
            return this;
        }
         ...
         * Jobs
         */
        public Builder getJobResponse(Optional<? extends apideck.ats.apideck.models.shared.GetJobResponse> getJobResponse) {
            Utils.checkNotNull(getJobResponse, "getJobResponse");
            this.getJobResponse = getJobResponse;
            return this;
        }
        ...
        public JobsOneResponse build() {
            return new JobsOneResponse(
                badRequestResponse,
                contentType,
                getJobResponse,
                notFoundResponse,
