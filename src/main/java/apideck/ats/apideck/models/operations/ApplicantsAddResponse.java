...
public class ApplicantsAddResponse implements apideck.ats.apideck.utils.Response {
     ...
     * Applicants
     */
    private Optional<? extends apideck.ats.apideck.models.shared.CreateApplicantResponse> createApplicantResponse;
    ...
    public ApplicantsAddResponse(
            Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse,
            String contentType,
            Optional<? extends apideck.ats.apideck.models.shared.CreateApplicantResponse> createApplicantResponse,
     ...
     * Applicants
     */
    public Optional<? extends apideck.ats.apideck.models.shared.CreateApplicantResponse> createApplicantResponse() {
     ...
     * Bad Request
     */
    public ApplicantsAddResponse withBadRequestResponse(Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse) {
        Utils.checkNotNull(badRequestResponse, "badRequestResponse");
        this.badRequestResponse = badRequestResponse;
        return this;
    }
     ...
     * Applicants
     */
    public ApplicantsAddResponse withCreateApplicantResponse(Optional<? extends apideck.ats.apideck.models.shared.CreateApplicantResponse> createApplicantResponse) {
        Utils.checkNotNull(createApplicantResponse, "createApplicantResponse");
        this.createApplicantResponse = createApplicantResponse;
        return this;
    }
     ...
     * The specified resource was not found
     */
    public ApplicantsAddResponse withNotFoundResponse(Optional<? extends apideck.ats.apideck.models.shared.NotFoundResponse> notFoundResponse) {
        Utils.checkNotNull(notFoundResponse, "notFoundResponse");
        this.notFoundResponse = notFoundResponse;
        return this;
    }
     ...
     * Payment Required
     */
    public ApplicantsAddResponse withPaymentRequiredResponse(Optional<? extends apideck.ats.apideck.models.shared.PaymentRequiredResponse> paymentRequiredResponse) {
        Utils.checkNotNull(paymentRequiredResponse, "paymentRequiredResponse");
        this.paymentRequiredResponse = paymentRequiredResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ApplicantsAddResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ApplicantsAddResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Unauthorized
     */
    public ApplicantsAddResponse withUnauthorizedResponse(Optional<? extends apideck.ats.apideck.models.shared.UnauthorizedResponse> unauthorizedResponse) {
        Utils.checkNotNull(unauthorizedResponse, "unauthorizedResponse");
        this.unauthorizedResponse = unauthorizedResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public ApplicantsAddResponse withUnexpectedErrorResponse(Optional<? extends apideck.ats.apideck.models.shared.UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
     ...
     * Unprocessable
     */
    public ApplicantsAddResponse withUnprocessableResponse(Optional<? extends apideck.ats.apideck.models.shared.UnprocessableResponse> unprocessableResponse) {
        Utils.checkNotNull(unprocessableResponse, "unprocessableResponse");
        this.unprocessableResponse = unprocessableResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicantsAddResponse other = (ApplicantsAddResponse) o;
        return 
            java.util.Objects.deepEquals(this.badRequestResponse, other.badRequestResponse) &&
            java.util.Objects.deepEquals(this.contentType, other.contentType) &&
            java.util.Objects.deepEquals(this.createApplicantResponse, other.createApplicantResponse) &&
    ...
    public String toString() {
        return Utils.toString(ApplicantsAddResponse.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends apideck.ats.apideck.models.shared.CreateApplicantResponse> createApplicantResponse = Optional.empty();
         ...
         * Applicants
         */
        public Builder createApplicantResponse(apideck.ats.apideck.models.shared.CreateApplicantResponse createApplicantResponse) {
            Utils.checkNotNull(createApplicantResponse, "createApplicantResponse");
            this.createApplicantResponse = Optional.ofNullable(createApplicantResponse);
            return this;
        }
         ...
         * Applicants
         */
        public Builder createApplicantResponse(Optional<? extends apideck.ats.apideck.models.shared.CreateApplicantResponse> createApplicantResponse) {
            Utils.checkNotNull(createApplicantResponse, "createApplicantResponse");
            this.createApplicantResponse = createApplicantResponse;
            return this;
        }
        ...
        public ApplicantsAddResponse build() {
            return new ApplicantsAddResponse(
                badRequestResponse,
                contentType,
                createApplicantResponse,
                notFoundResponse,
