...
public class ApplicantsAllResponse implements apideck.ats.apideck.utils.Response {
     ...
     * Applicants
     */
    private Optional<? extends apideck.ats.apideck.models.shared.GetApplicantsResponse> getApplicantsResponse;
    ...
    public ApplicantsAllResponse(
            Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse,
            String contentType,
            Optional<? extends apideck.ats.apideck.models.shared.GetApplicantsResponse> getApplicantsResponse,
     ...
     * Applicants
     */
    public Optional<? extends apideck.ats.apideck.models.shared.GetApplicantsResponse> getApplicantsResponse() {
     ...
     * Bad Request
     */
    public ApplicantsAllResponse withBadRequestResponse(Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse) {
        Utils.checkNotNull(badRequestResponse, "badRequestResponse");
        this.badRequestResponse = badRequestResponse;
        return this;
    }
     ...
     * Applicants
     */
    public ApplicantsAllResponse withGetApplicantsResponse(Optional<? extends apideck.ats.apideck.models.shared.GetApplicantsResponse> getApplicantsResponse) {
        Utils.checkNotNull(getApplicantsResponse, "getApplicantsResponse");
        this.getApplicantsResponse = getApplicantsResponse;
        return this;
    }
     ...
     * The specified resource was not found
     */
    public ApplicantsAllResponse withNotFoundResponse(Optional<? extends apideck.ats.apideck.models.shared.NotFoundResponse> notFoundResponse) {
        Utils.checkNotNull(notFoundResponse, "notFoundResponse");
        this.notFoundResponse = notFoundResponse;
        return this;
    }
     ...
     * Payment Required
     */
    public ApplicantsAllResponse withPaymentRequiredResponse(Optional<? extends apideck.ats.apideck.models.shared.PaymentRequiredResponse> paymentRequiredResponse) {
        Utils.checkNotNull(paymentRequiredResponse, "paymentRequiredResponse");
        this.paymentRequiredResponse = paymentRequiredResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ApplicantsAllResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ApplicantsAllResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Unauthorized
     */
    public ApplicantsAllResponse withUnauthorizedResponse(Optional<? extends apideck.ats.apideck.models.shared.UnauthorizedResponse> unauthorizedResponse) {
        Utils.checkNotNull(unauthorizedResponse, "unauthorizedResponse");
        this.unauthorizedResponse = unauthorizedResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public ApplicantsAllResponse withUnexpectedErrorResponse(Optional<? extends apideck.ats.apideck.models.shared.UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
     ...
     * Unprocessable
     */
    public ApplicantsAllResponse withUnprocessableResponse(Optional<? extends apideck.ats.apideck.models.shared.UnprocessableResponse> unprocessableResponse) {
        Utils.checkNotNull(unprocessableResponse, "unprocessableResponse");
        this.unprocessableResponse = unprocessableResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicantsAllResponse other = (ApplicantsAllResponse) o;
        return 
            java.util.Objects.deepEquals(this.badRequestResponse, other.badRequestResponse) &&
            java.util.Objects.deepEquals(this.contentType, other.contentType) &&
            java.util.Objects.deepEquals(this.getApplicantsResponse, other.getApplicantsResponse) &&
    ...
    public String toString() {
        return Utils.toString(ApplicantsAllResponse.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends apideck.ats.apideck.models.shared.GetApplicantsResponse> getApplicantsResponse = Optional.empty();
         ...
         * Applicants
         */
        public Builder getApplicantsResponse(apideck.ats.apideck.models.shared.GetApplicantsResponse getApplicantsResponse) {
            Utils.checkNotNull(getApplicantsResponse, "getApplicantsResponse");
            this.getApplicantsResponse = Optional.ofNullable(getApplicantsResponse);
            return this;
        }
         ...
         * Applicants
         */
        public Builder getApplicantsResponse(Optional<? extends apideck.ats.apideck.models.shared.GetApplicantsResponse> getApplicantsResponse) {
            Utils.checkNotNull(getApplicantsResponse, "getApplicantsResponse");
            this.getApplicantsResponse = getApplicantsResponse;
            return this;
        }
        ...
        public ApplicantsAllResponse build() {
            return new ApplicantsAllResponse(
                badRequestResponse,
                contentType,
                getApplicantsResponse,
                notFoundResponse,
