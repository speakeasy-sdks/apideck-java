...
public class ApplicantsDeleteResponse implements apideck.ats.apideck.utils.Response {
     ...
     * Applicants
     */
    private Optional<? extends apideck.ats.apideck.models.shared.DeleteApplicantResponse> deleteApplicantResponse;
    ...
    public ApplicantsDeleteResponse(
            Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse,
            String contentType,
            Optional<? extends apideck.ats.apideck.models.shared.DeleteApplicantResponse> deleteApplicantResponse,
     ...
     * Applicants
     */
    public Optional<? extends apideck.ats.apideck.models.shared.DeleteApplicantResponse> deleteApplicantResponse() {
     ...
     * Bad Request
     */
    public ApplicantsDeleteResponse withBadRequestResponse(Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse) {
        Utils.checkNotNull(badRequestResponse, "badRequestResponse");
        this.badRequestResponse = badRequestResponse;
        return this;
    }
     ...
     * Applicants
     */
    public ApplicantsDeleteResponse withDeleteApplicantResponse(Optional<? extends apideck.ats.apideck.models.shared.DeleteApplicantResponse> deleteApplicantResponse) {
        Utils.checkNotNull(deleteApplicantResponse, "deleteApplicantResponse");
        this.deleteApplicantResponse = deleteApplicantResponse;
        return this;
    }
     ...
     * The specified resource was not found
     */
    public ApplicantsDeleteResponse withNotFoundResponse(Optional<? extends apideck.ats.apideck.models.shared.NotFoundResponse> notFoundResponse) {
        Utils.checkNotNull(notFoundResponse, "notFoundResponse");
        this.notFoundResponse = notFoundResponse;
        return this;
    }
     ...
     * Payment Required
     */
    public ApplicantsDeleteResponse withPaymentRequiredResponse(Optional<? extends apideck.ats.apideck.models.shared.PaymentRequiredResponse> paymentRequiredResponse) {
        Utils.checkNotNull(paymentRequiredResponse, "paymentRequiredResponse");
        this.paymentRequiredResponse = paymentRequiredResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ApplicantsDeleteResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ApplicantsDeleteResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Unauthorized
     */
    public ApplicantsDeleteResponse withUnauthorizedResponse(Optional<? extends apideck.ats.apideck.models.shared.UnauthorizedResponse> unauthorizedResponse) {
        Utils.checkNotNull(unauthorizedResponse, "unauthorizedResponse");
        this.unauthorizedResponse = unauthorizedResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public ApplicantsDeleteResponse withUnexpectedErrorResponse(Optional<? extends apideck.ats.apideck.models.shared.UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
     ...
     * Unprocessable
     */
    public ApplicantsDeleteResponse withUnprocessableResponse(Optional<? extends apideck.ats.apideck.models.shared.UnprocessableResponse> unprocessableResponse) {
        Utils.checkNotNull(unprocessableResponse, "unprocessableResponse");
        this.unprocessableResponse = unprocessableResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicantsDeleteResponse other = (ApplicantsDeleteResponse) o;
        return 
            java.util.Objects.deepEquals(this.badRequestResponse, other.badRequestResponse) &&
            java.util.Objects.deepEquals(this.contentType, other.contentType) &&
            java.util.Objects.deepEquals(this.deleteApplicantResponse, other.deleteApplicantResponse) &&
    ...
    public String toString() {
        return Utils.toString(ApplicantsDeleteResponse.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends apideck.ats.apideck.models.shared.DeleteApplicantResponse> deleteApplicantResponse = Optional.empty();
         ...
         * Applicants
         */
        public Builder deleteApplicantResponse(apideck.ats.apideck.models.shared.DeleteApplicantResponse deleteApplicantResponse) {
            Utils.checkNotNull(deleteApplicantResponse, "deleteApplicantResponse");
            this.deleteApplicantResponse = Optional.ofNullable(deleteApplicantResponse);
            return this;
        }
         ...
         * Applicants
         */
        public Builder deleteApplicantResponse(Optional<? extends apideck.ats.apideck.models.shared.DeleteApplicantResponse> deleteApplicantResponse) {
            Utils.checkNotNull(deleteApplicantResponse, "deleteApplicantResponse");
            this.deleteApplicantResponse = deleteApplicantResponse;
            return this;
        }
        ...
        public ApplicantsDeleteResponse build() {
            return new ApplicantsDeleteResponse(
                badRequestResponse,
                contentType,
                deleteApplicantResponse,
                notFoundResponse,
