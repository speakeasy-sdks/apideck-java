...
public class ApplicationsAllResponse implements apideck.ats.apideck.utils.Response {
     ...
     * Applications
     */
    private Optional<? extends apideck.ats.apideck.models.shared.GetApplicationsResponse> getApplicationsResponse;
    ...
    public ApplicationsAllResponse(
            Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse,
            String contentType,
            Optional<? extends apideck.ats.apideck.models.shared.GetApplicationsResponse> getApplicationsResponse,
     ...
     * Applications
     */
    public Optional<? extends apideck.ats.apideck.models.shared.GetApplicationsResponse> getApplicationsResponse() {
     ...
     * Bad Request
     */
    public ApplicationsAllResponse withBadRequestResponse(Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse) {
        Utils.checkNotNull(badRequestResponse, "badRequestResponse");
        this.badRequestResponse = badRequestResponse;
        return this;
    }
     ...
     * Applications
     */
    public ApplicationsAllResponse withGetApplicationsResponse(Optional<? extends apideck.ats.apideck.models.shared.GetApplicationsResponse> getApplicationsResponse) {
        Utils.checkNotNull(getApplicationsResponse, "getApplicationsResponse");
        this.getApplicationsResponse = getApplicationsResponse;
        return this;
    }
     ...
     * The specified resource was not found
     */
    public ApplicationsAllResponse withNotFoundResponse(Optional<? extends apideck.ats.apideck.models.shared.NotFoundResponse> notFoundResponse) {
        Utils.checkNotNull(notFoundResponse, "notFoundResponse");
        this.notFoundResponse = notFoundResponse;
        return this;
    }
     ...
     * Payment Required
     */
    public ApplicationsAllResponse withPaymentRequiredResponse(Optional<? extends apideck.ats.apideck.models.shared.PaymentRequiredResponse> paymentRequiredResponse) {
        Utils.checkNotNull(paymentRequiredResponse, "paymentRequiredResponse");
        this.paymentRequiredResponse = paymentRequiredResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ApplicationsAllResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ApplicationsAllResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Unauthorized
     */
    public ApplicationsAllResponse withUnauthorizedResponse(Optional<? extends apideck.ats.apideck.models.shared.UnauthorizedResponse> unauthorizedResponse) {
        Utils.checkNotNull(unauthorizedResponse, "unauthorizedResponse");
        this.unauthorizedResponse = unauthorizedResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public ApplicationsAllResponse withUnexpectedErrorResponse(Optional<? extends apideck.ats.apideck.models.shared.UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
     ...
     * Unprocessable
     */
    public ApplicationsAllResponse withUnprocessableResponse(Optional<? extends apideck.ats.apideck.models.shared.UnprocessableResponse> unprocessableResponse) {
        Utils.checkNotNull(unprocessableResponse, "unprocessableResponse");
        this.unprocessableResponse = unprocessableResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicationsAllResponse other = (ApplicationsAllResponse) o;
        return 
            java.util.Objects.deepEquals(this.badRequestResponse, other.badRequestResponse) &&
            java.util.Objects.deepEquals(this.contentType, other.contentType) &&
            java.util.Objects.deepEquals(this.getApplicationsResponse, other.getApplicationsResponse) &&
    ...
    public String toString() {
        return Utils.toString(ApplicationsAllResponse.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends apideck.ats.apideck.models.shared.GetApplicationsResponse> getApplicationsResponse = Optional.empty();
         ...
         * Applications
         */
        public Builder getApplicationsResponse(apideck.ats.apideck.models.shared.GetApplicationsResponse getApplicationsResponse) {
            Utils.checkNotNull(getApplicationsResponse, "getApplicationsResponse");
            this.getApplicationsResponse = Optional.ofNullable(getApplicationsResponse);
            return this;
        }
         ...
         * Applications
         */
        public Builder getApplicationsResponse(Optional<? extends apideck.ats.apideck.models.shared.GetApplicationsResponse> getApplicationsResponse) {
            Utils.checkNotNull(getApplicationsResponse, "getApplicationsResponse");
            this.getApplicationsResponse = getApplicationsResponse;
            return this;
        }
        ...
        public ApplicationsAllResponse build() {
            return new ApplicationsAllResponse(
                badRequestResponse,
                contentType,
                getApplicationsResponse,
                notFoundResponse,
