...
public class ApplicantsOneResponse implements apideck.ats.apideck.utils.Response {
     ...
     * Applicants
     */
    private Optional<? extends apideck.ats.apideck.models.shared.GetApplicantResponse> getApplicantResponse;
    ...
    public ApplicantsOneResponse(
            Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse,
            String contentType,
            Optional<? extends apideck.ats.apideck.models.shared.GetApplicantResponse> getApplicantResponse,
     ...
     * Applicants
     */
    public Optional<? extends apideck.ats.apideck.models.shared.GetApplicantResponse> getApplicantResponse() {
     ...
     * Bad Request
     */
    public ApplicantsOneResponse withBadRequestResponse(Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse) {
        Utils.checkNotNull(badRequestResponse, "badRequestResponse");
        this.badRequestResponse = badRequestResponse;
        return this;
    }
     ...
     * Applicants
     */
    public ApplicantsOneResponse withGetApplicantResponse(Optional<? extends apideck.ats.apideck.models.shared.GetApplicantResponse> getApplicantResponse) {
        Utils.checkNotNull(getApplicantResponse, "getApplicantResponse");
        this.getApplicantResponse = getApplicantResponse;
        return this;
    }
     ...
     * The specified resource was not found
     */
    public ApplicantsOneResponse withNotFoundResponse(Optional<? extends apideck.ats.apideck.models.shared.NotFoundResponse> notFoundResponse) {
        Utils.checkNotNull(notFoundResponse, "notFoundResponse");
        this.notFoundResponse = notFoundResponse;
        return this;
    }
     ...
     * Payment Required
     */
    public ApplicantsOneResponse withPaymentRequiredResponse(Optional<? extends apideck.ats.apideck.models.shared.PaymentRequiredResponse> paymentRequiredResponse) {
        Utils.checkNotNull(paymentRequiredResponse, "paymentRequiredResponse");
        this.paymentRequiredResponse = paymentRequiredResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public ApplicantsOneResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public ApplicantsOneResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Unauthorized
     */
    public ApplicantsOneResponse withUnauthorizedResponse(Optional<? extends apideck.ats.apideck.models.shared.UnauthorizedResponse> unauthorizedResponse) {
        Utils.checkNotNull(unauthorizedResponse, "unauthorizedResponse");
        this.unauthorizedResponse = unauthorizedResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public ApplicantsOneResponse withUnexpectedErrorResponse(Optional<? extends apideck.ats.apideck.models.shared.UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
     ...
     * Unprocessable
     */
    public ApplicantsOneResponse withUnprocessableResponse(Optional<? extends apideck.ats.apideck.models.shared.UnprocessableResponse> unprocessableResponse) {
        Utils.checkNotNull(unprocessableResponse, "unprocessableResponse");
        this.unprocessableResponse = unprocessableResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicantsOneResponse other = (ApplicantsOneResponse) o;
        return 
            java.util.Objects.deepEquals(this.badRequestResponse, other.badRequestResponse) &&
            java.util.Objects.deepEquals(this.contentType, other.contentType) &&
            java.util.Objects.deepEquals(this.getApplicantResponse, other.getApplicantResponse) &&
    ...
    public String toString() {
        return Utils.toString(ApplicantsOneResponse.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends apideck.ats.apideck.models.shared.GetApplicantResponse> getApplicantResponse = Optional.empty();
         ...
         * Applicants
         */
        public Builder getApplicantResponse(apideck.ats.apideck.models.shared.GetApplicantResponse getApplicantResponse) {
            Utils.checkNotNull(getApplicantResponse, "getApplicantResponse");
            this.getApplicantResponse = Optional.ofNullable(getApplicantResponse);
            return this;
        }
         ...
         * Applicants
         */
        public Builder getApplicantResponse(Optional<? extends apideck.ats.apideck.models.shared.GetApplicantResponse> getApplicantResponse) {
            Utils.checkNotNull(getApplicantResponse, "getApplicantResponse");
            this.getApplicantResponse = getApplicantResponse;
            return this;
        }
        ...
        public ApplicantsOneResponse build() {
            return new ApplicantsOneResponse(
                badRequestResponse,
                contentType,
                getApplicantResponse,
                notFoundResponse,
