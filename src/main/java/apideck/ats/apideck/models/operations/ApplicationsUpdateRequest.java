...
public class ApplicationsUpdateRequest {
    ...
    private apideck.ats.apideck.models.shared.ApplicationInput application;
    ...
    public ApplicationsUpdateRequest(
            apideck.ats.apideck.models.shared.ApplicationInput application,
            String id,
    ...
    public apideck.ats.apideck.models.shared.ApplicationInput application() {
        return application;
    }
    ...
    public ApplicationsUpdateRequest withApplication(apideck.ats.apideck.models.shared.ApplicationInput application) {
        Utils.checkNotNull(application, "application");
        this.application = application;
        return this;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public ApplicationsUpdateRequest withRaw(Optional<? extends Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public ApplicationsUpdateRequest withXApideckAppId(Optional<? extends String> xApideckAppId) {
        Utils.checkNotNull(xApideckAppId, "xApideckAppId");
        this.xApideckAppId = xApideckAppId;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public ApplicationsUpdateRequest withXApideckConsumerId(Optional<? extends String> xApideckConsumerId) {
        Utils.checkNotNull(xApideckConsumerId, "xApideckConsumerId");
        this.xApideckConsumerId = xApideckConsumerId;
        return this;
    }
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public ApplicationsUpdateRequest withXApideckServiceId(Optional<? extends String> xApideckServiceId) {
        Utils.checkNotNull(xApideckServiceId, "xApideckServiceId");
        this.xApideckServiceId = xApideckServiceId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicationsUpdateRequest other = (ApplicationsUpdateRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ApplicationsUpdateRequest.class,
    ...
    public final static class Builder {
        ...
        public Builder application(apideck.ats.apideck.models.shared.ApplicationInput application) {
            Utils.checkNotNull(application, "application");
            this.application = application;
            return this;
        }
        ...
        public ApplicationsUpdateRequest build() {
            if (raw == null) {
                raw = _SINGLETON_VALUE_Raw.value();
            }
            return new ApplicationsUpdateRequest(
                application,
                id,
                raw,
                xApideckAppId,
