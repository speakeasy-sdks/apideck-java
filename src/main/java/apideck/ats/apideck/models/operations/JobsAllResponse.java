...
public class JobsAllResponse implements apideck.ats.apideck.utils.Response {
     ...
     * Jobs
     */
    private Optional<? extends apideck.ats.apideck.models.shared.GetJobsResponse> getJobsResponse;
    ...
    public JobsAllResponse(
            Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse,
            String contentType,
            Optional<? extends apideck.ats.apideck.models.shared.GetJobsResponse> getJobsResponse,
     ...
     * Jobs
     */
    public Optional<? extends apideck.ats.apideck.models.shared.GetJobsResponse> getJobsResponse() {
     ...
     * Bad Request
     */
    public JobsAllResponse withBadRequestResponse(Optional<? extends apideck.ats.apideck.models.shared.BadRequestResponse> badRequestResponse) {
        Utils.checkNotNull(badRequestResponse, "badRequestResponse");
        this.badRequestResponse = badRequestResponse;
        return this;
    }
     ...
     * Jobs
     */
    public JobsAllResponse withGetJobsResponse(Optional<? extends apideck.ats.apideck.models.shared.GetJobsResponse> getJobsResponse) {
        Utils.checkNotNull(getJobsResponse, "getJobsResponse");
        this.getJobsResponse = getJobsResponse;
        return this;
    }
     ...
     * The specified resource was not found
     */
    public JobsAllResponse withNotFoundResponse(Optional<? extends apideck.ats.apideck.models.shared.NotFoundResponse> notFoundResponse) {
        Utils.checkNotNull(notFoundResponse, "notFoundResponse");
        this.notFoundResponse = notFoundResponse;
        return this;
    }
     ...
     * Payment Required
     */
    public JobsAllResponse withPaymentRequiredResponse(Optional<? extends apideck.ats.apideck.models.shared.PaymentRequiredResponse> paymentRequiredResponse) {
        Utils.checkNotNull(paymentRequiredResponse, "paymentRequiredResponse");
        this.paymentRequiredResponse = paymentRequiredResponse;
        return this;
    }
     ...
     * HTTP response status code for this operation
     */
    public JobsAllResponse withStatusCode(int statusCode) {
        Utils.checkNotNull(statusCode, "statusCode");
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public JobsAllResponse withRawResponse(HttpResponse<InputStream> rawResponse) {
        Utils.checkNotNull(rawResponse, "rawResponse");
        this.rawResponse = rawResponse;
        return this;
    }
     ...
     * Unauthorized
     */
    public JobsAllResponse withUnauthorizedResponse(Optional<? extends apideck.ats.apideck.models.shared.UnauthorizedResponse> unauthorizedResponse) {
        Utils.checkNotNull(unauthorizedResponse, "unauthorizedResponse");
        this.unauthorizedResponse = unauthorizedResponse;
        return this;
    }
     ...
     * Unexpected error
     */
    public JobsAllResponse withUnexpectedErrorResponse(Optional<? extends apideck.ats.apideck.models.shared.UnexpectedErrorResponse> unexpectedErrorResponse) {
        Utils.checkNotNull(unexpectedErrorResponse, "unexpectedErrorResponse");
        this.unexpectedErrorResponse = unexpectedErrorResponse;
        return this;
    }
     ...
     * Unprocessable
     */
    public JobsAllResponse withUnprocessableResponse(Optional<? extends apideck.ats.apideck.models.shared.UnprocessableResponse> unprocessableResponse) {
        Utils.checkNotNull(unprocessableResponse, "unprocessableResponse");
        this.unprocessableResponse = unprocessableResponse;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        JobsAllResponse other = (JobsAllResponse) o;
        return 
            java.util.Objects.deepEquals(this.badRequestResponse, other.badRequestResponse) &&
            java.util.Objects.deepEquals(this.contentType, other.contentType) &&
            java.util.Objects.deepEquals(this.getJobsResponse, other.getJobsResponse) &&
    ...
    public String toString() {
        return Utils.toString(JobsAllResponse.class,
    ...
    public final static class Builder {
        ...
        private Optional<? extends apideck.ats.apideck.models.shared.GetJobsResponse> getJobsResponse = Optional.empty();
         ...
         * Jobs
         */
        public Builder getJobsResponse(apideck.ats.apideck.models.shared.GetJobsResponse getJobsResponse) {
            Utils.checkNotNull(getJobsResponse, "getJobsResponse");
            this.getJobsResponse = Optional.ofNullable(getJobsResponse);
            return this;
        }
         ...
         * Jobs
         */
        public Builder getJobsResponse(Optional<? extends apideck.ats.apideck.models.shared.GetJobsResponse> getJobsResponse) {
            Utils.checkNotNull(getJobsResponse, "getJobsResponse");
            this.getJobsResponse = getJobsResponse;
            return this;
        }
        ...
        public JobsAllResponse build() {
            return new JobsAllResponse(
                badRequestResponse,
                contentType,
                getJobsResponse,
                notFoundResponse,
