...
public class ApplicationsDeleteRequest {
    ...
    public ApplicationsDeleteRequest(
            String id,
     ...
     * ID of the record you are acting upon.
     */
    public ApplicationsDeleteRequest withId(String id) {
        Utils.checkNotNull(id, "id");
        this.id = id;
        return this;
    }
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public ApplicationsDeleteRequest withRaw(boolean raw) {
        Utils.checkNotNull(raw, "raw");
     ...
     * Include raw response. Mostly used for debugging purposes
     */
    public ApplicationsDeleteRequest withRaw(Optional<? extends Boolean> raw) {
        Utils.checkNotNull(raw, "raw");
        this.raw = raw;
        return this;
    }
     ...
     * The ID of your Unify application
     */
    public ApplicationsDeleteRequest withXApideckAppId(String xApideckAppId) {
        Utils.checkNotNull(xApideckAppId, "xApideckAppId");
     ...
     * The ID of your Unify application
     */
    public ApplicationsDeleteRequest withXApideckAppId(Optional<? extends String> xApideckAppId) {
        Utils.checkNotNull(xApideckAppId, "xApideckAppId");
        this.xApideckAppId = xApideckAppId;
        return this;
    }
     ...
     * ID of the consumer which you want to get or push data from
     */
    public ApplicationsDeleteRequest withXApideckConsumerId(String xApideckConsumerId) {
        Utils.checkNotNull(xApideckConsumerId, "xApideckConsumerId");
     ...
     * ID of the consumer which you want to get or push data from
     */
    public ApplicationsDeleteRequest withXApideckConsumerId(Optional<? extends String> xApideckConsumerId) {
        Utils.checkNotNull(xApideckConsumerId, "xApideckConsumerId");
        this.xApideckConsumerId = xApideckConsumerId;
        return this;
    }
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public ApplicationsDeleteRequest withXApideckServiceId(String xApideckServiceId) {
        Utils.checkNotNull(xApideckServiceId, "xApideckServiceId");
     ...
     * Provide the service id you want to call (e.g., pipedrive). Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public ApplicationsDeleteRequest withXApideckServiceId(Optional<? extends String> xApideckServiceId) {
        Utils.checkNotNull(xApideckServiceId, "xApideckServiceId");
        this.xApideckServiceId = xApideckServiceId;
        return this;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ApplicationsDeleteRequest other = (ApplicationsDeleteRequest) o;
        return 
    ...
    public String toString() {
        return Utils.toString(ApplicationsDeleteRequest.class,
                "id", id,
                "raw", raw,
    ...
    public final static class Builder {
        ...
        public ApplicationsDeleteRequest build() {
            if (raw == null) {
                raw = _SINGLETON_VALUE_Raw.value();
            }
            return new ApplicationsDeleteRequest(
                id,
                raw,
                xApideckAppId,
                xApideckConsumerId,
